...
if exist "assets\branding\icon.ico" goto :skip_icon
...
set "ISCC_PATH="
if exist "%SystemDrive%\Program Files (x86)\Inno Setup 6\ISCC.exe" set "ISCC_PATH=%SystemDrive%\Program Files (x86)\Inno Setup 6\ISCC.exe"
if exist "%SystemDrive%\Program Files\Inno Setup 6\ISCC.exe" set "ISCC_PATH=%SystemDrive%\Program Files\Inno Setup 6\ISCC.exe"
if exist "%SystemDrive%\Program Files (x86)\Inno Setup 5\ISCC.exe" set "ISCC_PATH=%SystemDrive%\Program Files (x86)\Inno Setup 5\ISCC.exe"
if exist "%SystemDrive%\Program Files\Inno Setup 5\ISCC.exe" set "ISCC_PATH=%SystemDrive%\Program Files\Inno Setup 5\ISCC.exe"

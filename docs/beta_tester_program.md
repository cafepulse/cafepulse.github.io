...
| **All Testers** | **Beta Tester Badge** | Exclusive badge displayed inside the CafePulse application. |

---

## 3. Bug Reporting & Diagnostic Workflow

Testers must submit issues using this structured process. See the [Bug Reporting Guide](./documentation.html?doc=bug_reporting_guide) for detailed instructions on how to submit bug reports and include video or image evidence.
